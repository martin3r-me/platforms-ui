{{--
  Component: Input Select (Atom)
  Zweck: Dropdown-Auswahlfeld mit Label und Validierung.
  Props:
    ...
    - options: array - Auswahloptionen
    - optionValue: string - Wert-Attribut der Optionen
    - optionLabel: string - Label-Attribut der Optionen
    - nullable: bool - Null-Option erlaubt
    - nullLabel: string|null - Label für Null-Option
  Beispiel:
    <x-ui-input-select name="priority" label="Priorität" :options="$priorities" optionValue="id" optionLabel="name" />
--}}
