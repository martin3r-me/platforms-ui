{{--
  Component: Dashboard Tile (Molecule)
  Zweck: Kachel für Kennzahlen mit Icon, Varianten, Größen und optionalem Link.
  API: identisch zur bisherigen Komponente, um eine reibungslose Migration zu gewährleisten.
--}}
...
@php
    ...
    $variantClasses = match($variant) {
        'primary' => [ 'bg' => 'bg-primary-5', 'border' => 'border-primary-20', 'text' => 'text-primary', 'hover' => 'hover:bg-primary-10', 'icon' => 'text-primary', 'count' => 'text-primary' ],
        'secondary' => [ 'bg' => 'bg-secondary-5', 'border' => 'border-secondary-20', 'text' => 'text-secondary', 'hover' => 'hover:bg-secondary-10', 'icon' => 'text-secondary', 'count' => 'text-secondary' ],
        'success' => [ 'bg' => 'bg-success-5', 'border' => 'border-success-20', 'text' => 'text-success', 'hover' => 'hover:bg-success-10', 'icon' => 'text-success', 'count' => 'text-success' ],
        'danger' => [ 'bg' => 'bg-danger-5', 'border' => 'border-danger-20', 'text' => 'text-danger', 'hover' => 'hover:bg-danger-10', 'icon' => 'text-danger', 'count' => 'text-danger' ],
        'warning' => [ 'bg' => 'bg-warning-5', 'border' => 'border-warning-20', 'text' => 'text-warning', 'hover' => 'hover:bg-warning-10', 'icon' => 'text-warning', 'count' => 'text-warning' ],
        'info' => [ 'bg' => 'bg-info-5', 'border' => 'border-info-20', 'text' => 'text-info', 'hover' => 'hover:bg-info-10', 'icon' => 'text-info', 'count' => 'text-info' ],
        'neutral' => [ 'bg' => 'bg-muted-5', 'border' => 'border-muted-20', 'text' => 'text-muted', 'hover' => 'hover:bg-muted-10', 'icon' => 'text-muted', 'count' => 'text-muted' ],
        default => [ 'bg' => 'bg-primary-5', 'border' => 'border-primary-20', 'text' => 'text-primary', 'hover' => 'hover:bg-primary-10', 'icon' => 'text-primary', 'count' => 'text-primary' ],
    };
